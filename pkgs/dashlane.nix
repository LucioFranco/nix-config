...
let
  ...
  binaries = {
    ...
    "x86_64-darwin" = {
      url = "https://github.com/Dashlane/dashlane-cli/releases/download/v${version}/dcli-macos-x64";
      sha256 = "";
    };
    "aarch64-darwin" = {
      url = "https://github.com/Dashlane/dashlane-cli/releases/download/v${version}/dcli-macos-arm64";
  ...
  bin = binaries.${system} or (throw "dashlane-cli: unsupported system ${system}");
